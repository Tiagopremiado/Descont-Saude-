...
// Se as chaves não estiverem definidas, as funcionalidades do Google Drive serão desabilitadas,
// mas a aplicação continuará funcionando normalmente com os dados locais.
